...
: ${AMENT_CURRENT_PREFIX:="/home/yyh/ws/install/smmg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/smmg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/smmg/environment/path.sh"
